...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setFixedSize(620, 593)
        ...
        self.send_btn.setStyleSheet("QPushButton { font-weight: bold; }")
        ...
        self.sendImg_btn.setStyleSheet("QPushButton { font-weight: bold; }")
        ...
        self.changeColor_btn.setText("Border Color")
        self.changeColor_btn.setStyleSheet("QPushButton { font-weight: bold; }")
        ...
        profile_pixmap = QPixmap("dp2.png")
        profile_pixmap = profile_pixmap.scaled(48, 48, QtCore.Qt.AspectRatioMode.KeepAspectRatio,QtCore.Qt.TransformationMode.SmoothTransformation)
